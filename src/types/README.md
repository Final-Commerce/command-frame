...
**Wire envelope types** (`PostMessageRequest`, `PostMessageResponse`) are defined in [`src/client.ts`](../client.ts) and exported from the package root for providers and advanced integrations.
