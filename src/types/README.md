...
| `customFee`         | [`CFCustomFee`](#cfcustomfee)`[]`                        | No       | Cart-level custom fees; array order matches [`getCurrentCart`](../actions/get-current-cart/README.md) and [`removeCartFee`](../actions/remove-cart-fee/README.md) (index `0` is the first fee). |
