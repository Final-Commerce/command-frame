...
- **[editCustomSale](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-custom-sale/README.md)** - Edit an existing custom sale line (label, price, quantity, taxes)
...
- **Catalog management:** [addProduct](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/add-product/README.md), [editCustomer](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-customer/README.md), [editProduct](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-product/README.md), [editProductVariants](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-product-variants/README.md), [deleteProduct](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/delete-product/README.md), [getProductVariants](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-product-variants/README.md), [getInventory](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-inventory/README.md), [getStockHistory](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-stock-history/README.md), [getProductVisibility](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-product-visibility/README.md), [getOutlets](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-outlets/README.md), [addCategory](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/add-category/README.md), [editCategory](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-category/README.md), [deleteCategory](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/delete-category/README.md), [addAttribute](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/add-attribute/README.md), [getAttributes](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-attributes/README.md), [editAttribute](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-attribute/README.md), [deleteAttribute](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/delete-attribute/README.md), [previewVariants](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/preview-variants/README.md), [computeVariantChanges](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/compute-variant-changes/README.md), [createProductWithVariants](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/create-product-with-variants/README.md), [updateProductBundle](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/update-product-bundle/README.md), [adjustStock](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/adjust-stock/README.md), [setProductOutlets](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/set-product-outlets/README.md), [uploadImage](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/upload-image/README.md), [getImages](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/get-images/README.md), [deleteImage](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/delete-image/README.md)
...
Adds a custom sale item to the cart in the parent window. Useful for adding non-product items like service fees, discounts, or custom charges. Accepts an optional `quantity` (defaults to 1).

### [editCustomSale](https://github.com/Final-Commerce/command-frame/blob/main/src/actions/edit-custom-sale/README.md)

Edits an existing custom sale line by its `customSaleId` — label, price, quantity, applyTaxes, taxTableId. Only the fields provided are changed.
