...
Published when an order's information is updated in the system.
...
|-------|------|-------------|
| `order` | [`CFOrder`](../../../../types/README.md#cforder) | The updated order object. See field reference below. |
