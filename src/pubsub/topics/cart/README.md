...
Event ids match [`cartTopic`](./index.ts) (`src/pubsub/topics/cart/index.ts`). There are **17** event types on this topic.
...
| [product-discount-added](./product-discount-added/README.md)     | Published when a discount is added to a cart line item     | [View Details](./product-discount-added/README.md)   |
| [product-discount-removed](./product-discount-removed/README.md) | Published when a discount is removed from a cart line item | [View Details](./product-discount-removed/README.md) |
| [product-fee-added](./product-fee-added/README.md)               | Published when a fee is added to a cart line item          | [View Details](./product-fee-added/README.md)        |
| [product-fee-removed](./product-fee-removed/README.md)           | Published when a fee is removed from a cart line item      | [View Details](./product-fee-removed/README.md)      |
| [product-note-added](./product-note-added/README.md)             | Published when a note is added to a cart line item         | [View Details](./product-note-added/README.md)       |
| [product-note-removed](./product-note-removed/README.md)         | Published when a note is removed from a cart line item     | [View Details](./product-note-removed/README.md)     |
...
const subscriptionId = topics.subscribe("cart", (event: TopicEvent) => {
    switch (event.type) {
        ...
        case "product-discount-added":
            console.log("Line discount added:", event.data.discount, event.data.product);
            break;
        case "product-discount-removed":
            console.log("Line discount removed:", event.data.product);
            break;
        case "product-fee-added":
            console.log("Line fee added:", event.data.fee, event.data.product);
            break;
        case "product-fee-removed":
            console.log("Line fee removed:", event.data.product);
            break;
        case "product-note-added":
            console.log("Line note added:", event.data.note, event.data.product);
            break;
        case "product-note-removed":
            console.log("Line note removed:", event.data.product);
            break;
    }
});
```
