...
The `cart` topic provides events related to cart operations. Subscribe to this topic to receive real-time notifications when the cart is created, customers are assigned or removed, products are added/updated/removed, cart-level discounts and fees change, or per-line discounts, fees, and notes change.
...
| [customer-unassigned](./customer-unassigned/README.md) | Published when a customer is removed from the cart (same payload as topic `customers`) | [View Details](./customer-unassigned/README.md) |
...
| [product-discount-added](./product-discount-added/README.md) | Published when a discount is added to a cart line | [View Details](./product-discount-added/README.md) |
| [product-discount-removed](./product-discount-removed/README.md) | Published when a discount is removed from a cart line | [View Details](./product-discount-removed/README.md) |
| [product-fee-added](./product-fee-added/README.md) | Published when a fee is added to a cart line | [View Details](./product-fee-added/README.md) |
| [product-fee-removed](./product-fee-removed/README.md) | Published when a fee is removed from a cart line | [View Details](./product-fee-removed/README.md) |
| [product-note-added](./product-note-added/README.md) | Published when a note is added to a cart line | [View Details](./product-note-added/README.md) |
| [product-note-removed](./product-note-removed/README.md) | Published when a note is removed from a cart line | [View Details](./product-note-removed/README.md) |
...
const subscriptionId = topics.subscribe('cart', (event: TopicEvent) => {
    switch (event.type) {
        ...
        case 'product-discount-added':
            console.log('Line discount added:', event.data.discount);
            break;
        case 'product-discount-removed':
            console.log('Line discount removed');
            break;
        case 'product-fee-added':
            console.log('Line fee added:', event.data.fee);
            break;
        case 'product-fee-removed':
            console.log('Line fee removed');
            break;
        case 'product-note-added':
            console.log('Line note:', event.data.note);
            break;
        case 'product-note-removed':
            console.log('Line note cleared');
            break;
    }
});
```
