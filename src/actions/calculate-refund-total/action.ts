...
import type { CalculateRefundTotal, CalculateRefundTotalParams, CalculateRefundTotalResponse } from './types';
...
export const calculateRefundTotal: CalculateRefundTotal = async (
  ...
  return await commandFrameClient.call<CalculateRefundTotalParams | undefined, CalculateRefundTotalResponse>(
