      ...
      <div className="app__main" style={{ marginLeft: 0, width: '100%' }}>
        ...
        <div className="app__content" style={{ padding: '20px', overflowY: 'auto' }}>
          ...
          <div className="section-content">
            ...
            <h2
              id="section-context"
              style={{ marginBottom: '16px', borderBottom: '1px solid #ddd', paddingBottom: '8px' }}
            >
              Context
            </h2>
              ...
              <div className="command-section__content">
                ...
                {products.length > 0 && (
                  <div style={{ marginTop: '16px' }}>
                    ...
                    >
                      <p style={{ fontSize: '12px', color: '#666', margin: 0 }}>
                        <strong>{products.length} product(s) shown</strong> (offset: {productsOffset}, limit:{' '}
                        {productsLimit})
                      </p>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                                  ...
                                  <div style={{ flex: 1 }}>
                                    ...
                                    >
                                      <div>
                                        ...
                                        {variant.sku && (
                                          <span style={{ color: '#999', marginLeft: '8px' }}>SKU: {variant.sku}</span>
                                        )}
                                        {variant.barcode && (
            ...
            <div className="command-section">
              ...
              <div className="command-section__content">
                ...
                {outletsFetched && outlets.length === 0 && (
                  <p style={{ marginTop: '12px', fontSize: '13px', color: '#999', fontStyle: 'italic' }}>
                    No outlets found.
                  </p>
                )}
              </div>
              ...
              <div className="command-section__content">
                ...
                {ordersFetched && (
                  <p style={{ fontSize: '12px', color: '#666', margin: '8px 0' }}>
                    <strong>{orders.length} order(s) shown</strong> (offset: {ordersOffset}, limit: {ordersLimit},
                    total: {ordersTotal})
                  </p>
                )}
                            ...
                            <div style={{ marginTop: '12px', borderTop: '1px solid #eee', paddingTop: '12px' }}>
                                ...
                                <div style={{ marginBottom: '8px' }}>
                                  ...
                                  <span style={{ fontSize: '11px', marginLeft: '8px' }}>
                                    {order.paymentMethods
                                      .map((pm: any) => `${pm.name || pm.type || 'Unknown'}: $${pm.amount || '0'}`)
                                      .join(', ')}
                                  </span>
                                </div>
                              )}
                              {order.summary && (
                                <div style={{ marginBottom: '8px' }}>
                                  ...
                                  <span style={{ fontSize: '11px', marginLeft: '8px' }}>
                                    Subtotal: ${order.summary.subTotal || '0'} | Tax: ${order.summary.totalTax || '0'} |
            ...
            <div className="command-section">
              ...
              <div className="command-section__content">
                ...
                {customTables.length === 0 && extensionIdInput && (
                  ...
                  >
                    No custom tables found for this extension. Make sure you have linked custom tables to this
                    extension.
                  </p>
                )}
              </div>
            ...
            <div className="command-section" id="section-get-data">
              ...
              <div className="command-section__content">
                ...
                >
                  ...
                  {totalCount !== null && (
                    <span style={{ fontSize: '12px', color: '#666' }}>Total: {totalCount} rows</span>
                  )}
                </div>
            ...
            <div className="command-section" id="section-create">
              ...
              <div className="command-section__content">
                <p style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
                  Create a new row in a custom table. The backend validates that all field names exist in the table
                  schema and that value types match. Uses a transaction for atomicity.
                </p>
                <div className="form-group" style={{ marginBottom: '12px' }}>
                  <label className="form-label">Table Name:</label>
                  <input
            ...
            <div className="command-section" id="section-update">
              ...
              <div className="command-section__content">
                <p style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
                  Update an existing row. The JSON <strong>must include the _id</strong> field. Select a row above to
                  pre-populate.
                </p>
                <div className="form-group" style={{ marginBottom: '12px' }}>
                  <label className="form-label">Table Name:</label>
            ...
            <div className="command-section">
              ...
              <div className="command-section__content">
                <p style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
                  Retrieves custom extensions installed for the current company. Uses aggregation to lookup extension
                  details.
                </p>
                <button
            ...
            <div className="command-section">
              ...
              <div className="command-section__content">
                <p style={{ fontSize: '12px', color: '#666', marginBottom: '8px' }}>
                  List secret keys for the company, or for a specific extension. Leave extension ID empty for
                  company-level keys.
                </p>
                <div className="form-group" style={{ marginBottom: '12px' }}>
              ...
              <div className="command-section__content">
                ...
                <div className="form-group" style={{ marginBottom: '12px' }}>
                  ...
                  <select
                    ...
                    onChange={(e) => setNotificationType(e.target.value as 'success' | 'error' | 'info' | 'warning')}
                    className="form-input"
                    style={{ width: '100%', padding: '8px', marginTop: '4px' }}
                  >
