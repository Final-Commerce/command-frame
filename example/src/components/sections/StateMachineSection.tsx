  ...
  return (
    <div className="section-content">
      ...
      <CommandSection title="Apply Transition">
        <p className="section-description">
          Apply a state transition to an order. The host validates the transition before applying it — a blocked result
          returns the guard name and reason without changing the order.
        </p>
        <div className="form-group">
          <div className="form-field">
            <label>Order ID:</label>
